...
lr_config = dict(
    ...
    warmup_ratio=0.001,
    step=[16, 22])
runner = dict(type='EpochBasedDynamicRunner', max_epochs=6)
...
log_level = 'INFO'
load_from = 'experiments/fasa_iif_r50_rfs_cos_norm_4x4_2x/latest.pth'
resume_from = None
workflow = [('train', 1), ('val', 1)]
# work_dir = 'experiments/test'
work_dir = 'experiments/fasa_iif_decoup_r50_rfs_cos_norm_4x4_2x'
gpu_ids = range(0, 4)
