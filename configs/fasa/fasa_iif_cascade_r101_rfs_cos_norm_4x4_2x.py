model = dict(
    ...
    roi_head=dict(
        type='StandardFASACascadeRoIHead',
        num_stages=3,
        ...
        bbox_head=[
            ...
            dict(
                ...
                bbox_coder=dict(
                    type='DeltaXYWHBBoxCoder',
                    target_means=[0.0, 0.0, 0.0, 0.0],
                    target_stds=[0.33, 0.33, 0.067, 0.067]),
                reg_class_agnostic=False,
                loss_cls=dict(
                    type='FasaIIFLoss',
                    use_sigmoid=False,
...
log_level = 'INFO'
load_from = None
resume_from = 'experiments/fasa_iif_cascade_r101_rfs_cos_norm_4x4_2x/latest.pth'
workflow = [('train', 1), ('val', 1)]
# work_dir = 'experiments/test'
work_dir = 'experiments/fasa_iif_cascade_r101_rfs_cos_norm_4x4_2x'
gpu_ids = range(0, 4)
