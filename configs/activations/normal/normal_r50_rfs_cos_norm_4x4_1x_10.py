...
model = dict(roi_head=dict(bbox_head=dict(loss_cls=dict(type="Icloglog",activation='normal'),
                                         cls_predictor_cfg=dict(type='NormedLinear', tempearture=10,init_bias=-3.2),
...
work_dir='./experiments/normal_r50_rfs_cos_norm_4x4_1x_10/'
resume_from = './experiments/normal_r50_rfs_cos_norm_4x4_1x_10/latest.pth'
