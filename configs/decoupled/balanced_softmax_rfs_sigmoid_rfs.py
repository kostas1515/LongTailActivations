model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='BalancedSoftmax', use_sigmoid=True,variant='prob', loss_weight=1.0),
            loss_bbox=dict(type='L1Loss', loss_weight=1.0),
            init_cfg=dict(
                type='Constant',
                val=0.001,
...
log_level = 'INFO'
load_from = './experiments/baselines/r50_rfs_4x4_1x/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = './experiments/balanced_softmax_sigmoid_rfs/'
